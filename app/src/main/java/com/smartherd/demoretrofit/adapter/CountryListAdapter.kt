package com.smartherd.demoretrofit.adapter
...
import com.smartherd.demoretrofit.R
import com.smartherd.demoretrofit.adapter.CountryListAdapter.MyViewHolder
import com.smartherd.demoretrofit.data.CountryModel
import kotlinx.android.synthetic.main.country_list_row.view.*
import kotlinx.android.synthetic.main.country_list_row.view.*


class CountryListAdapter(val activity: Activity): RecyclerView.Adapter<MyViewHolder>() {
